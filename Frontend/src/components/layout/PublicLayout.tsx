        ...
        <nav className="flex min-w-0 items-center gap-1 sm:gap-3">
          ...
          {status === 'authed' && user ? (
            <button
              ...
              className="public-btn--nav-cta shrink-0 whitespace-nowrap rounded-xl bg-[#0D9488] px-2.5 py-1 font-semibold text-white shadow-sm transition-all hover:bg-[#0B7A70] sm:px-4 sm:py-1.5"
            >
              {t('nav.dashboard')}
            </button>
          ) : (
            <>
              <button
                ...
                className="public-btn--nav-cta shrink-0 whitespace-nowrap rounded-xl px-2 py-1 font-semibold text-slate-700 transition-all hover:bg-slate-100 sm:px-3.5 sm:py-1.5"
              >
                {t('auth.signIn')}
              </button>
              <button
                ...
                className="public-btn--nav-cta shrink-0 whitespace-nowrap rounded-xl bg-[#0D9488] px-2 py-1 font-semibold text-white shadow-sm transition-all hover:bg-[#0B7A70] sm:px-4 sm:py-1.5"
              >
