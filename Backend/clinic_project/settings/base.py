...
env = environ.Env(
    ...
    PENDING_EXPIRY_GRACE_MINUTES=(int, 15),
    NO_SHOW_GRACE_MINUTES=(int, 20),
    RELIABILITY_NO_SHOW_PENALTY=(int, 25),
...
LOCAL_APPS = [
    ...
    "apps.accounting",    # Financial roadmap — double-entry accounting core
]
...
# Auto-cancel / patient reliability (grace windows + scoring knob).
PENDING_EXPIRY_GRACE_MINUTES = env("PENDING_EXPIRY_GRACE_MINUTES")  # PENDING -> EXPIRED
NO_SHOW_GRACE_MINUTES = env("NO_SHOW_GRACE_MINUTES")                # CONFIRMED -> NO_SHOW
RELIABILITY_NO_SHOW_PENALTY = env("RELIABILITY_NO_SHOW_PENALTY")    # points lost per no-show
